...
__all__.append("CalendarChartWdg")
...
class CalendarChartWdg(BaseChartWdg):
    ...
    def get_display(my):
        ...
        if expression:
            ...
            #search.add_filter("project_code", "fickle3")
        ...
        if y_title:
            ...
            y_axis_div.add_style("font-size: 16px")
        ...
        if x_title:
            ...
            x_axis_div.add_style("font-size: 16px")
