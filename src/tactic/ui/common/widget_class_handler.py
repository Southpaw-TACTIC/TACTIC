...
class WidgetClassHandler(object):
    ...
    def __init__(my):
        ...
        <element name='expression' help='expression-element-wdg'>
        ...
        <element name='button' help='button-element-wdg'>
        ...
        <element name='hidden_row' help='hidden-row-toggle-wdg'>
            <!--
        ...
        <element name='calendar_time'>
            <display class='tactic.ui.widget.CalendarTimeInputWdg'/>
        </element>
        <element name='time'>
