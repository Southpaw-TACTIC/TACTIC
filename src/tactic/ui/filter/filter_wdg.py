...
class GeneralFilterWdg(BaseFilterWdg):
    ...
    def init(my):
        ...
        assert my.mode in ['sobject', 'parent', 'child','custom']
    ...
    def get_display(my):
        ...
        #filter_template = my.get_filter_wdg("filter_template", -1)
        ...
        #filter_container.add_class("SPT_DTS")
    ...
    def get_search_type_selector(my, filter_name, filter_index):
        ...
        behavior = {
            'type': 'change',
            'cbfn_action': 'spt.dg_table.set_filter2',
            'prefix': my.prefix,
