...
from tactic.ui.container import HorizLayoutWdg, PopupWdg, RoundedCornerDivWdg, Menu, MenuItem
...
class ManageViewPanelWdg(BaseRefreshWdg):
    ...
    def get_display(my):
        ...
        td.add(tool_bar)
        tool_bar.add_gradient("background", "background", -10)
...
class ManageSideBarDetailWdg(BaseRefreshWdg):
    ...
    def get_display(my):
        ...
        title_div.add_style("margin-left: -10px")
        title_div.add_style("margin-right: -10px")
