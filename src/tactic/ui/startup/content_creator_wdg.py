...
class ContentCreatorWdg(BaseRefreshWdg):
    ...
    def get_display(my):
        ...
        title = TitleWdg(title='Content Creator Home')
        top.add(title)
        ...
        description = '''Dashoards display key project data in single views. Drill down further to work on tasks, make status changes or add notes.'''
