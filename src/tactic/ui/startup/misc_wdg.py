...
__all__ = ['TitleWdg', 'QuickLinksWdg', 'ShelfWdg']
...
class QuickLinksWdg(BaseRefreshWdg):
    ...
    def get_display(my):
        ...
        icon = IconWdg("TACTIC Documentation", IconWdg.DOCUMENTATION)

        icon.set_box_shadow("1px 1px 1px 1px")
        ...
        icon = IconWdg("Southpaw Web Site", IconWdg.WEBSITE)
        ...
        icon = IconWdg("TACTIC Community", IconWdg.COMMUNITY)
