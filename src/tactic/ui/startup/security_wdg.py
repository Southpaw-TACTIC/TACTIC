...
class SecurityCheckboxElementWdg(SimpleTableElementWdg):
    ...
    def get_title(my):
        ...
        if namespace:
            namespace_div = DivWdg()
            div.add(namespace_div)
            namespace_div.add_style("opacity: 0.5")
            namespace_div.add("%s / " % namespace)
            namespace_div.add_style("font-size: 9px")
            namespace_div.add_style("float: left")
