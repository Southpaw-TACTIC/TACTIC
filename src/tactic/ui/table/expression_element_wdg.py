...
class ExpressionElementWdg(TypeTableElementWdg):
    ...
    'justify': {
        'description': 'Result justificaiton',
        'type': 'SelectWdg',
        ...
        try:
            ...
            if calc_mode == 'fast':
                if my.cache_results == None:
                    my.cache_results = parser.eval(expression, my.sobjects, vars=my.vars, dictionary=True)
                ...
                result = parser.eval(expression, sobject, vars=my.vars, single=single, list=list)
        ...
        if my.mode == 'value':
            ...
            if display_expr:
                ...
                if return_type == 'single':
                    ...
                    single = True
                    list = False
                display_result = Search.eval(display_expr, my.sobject, list=list, single=single, vars={'VALUE': display_result })
