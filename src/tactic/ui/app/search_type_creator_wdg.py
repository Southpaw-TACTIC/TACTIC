    ...
    def get_submit_input(my):
        ...
        behavior = {
            ...
            var yes = function(){
                ...
                var server = TacticServerStub.get();
                server.start({title: "Register sType", 'description': 'Register sType [' + search_type + ']'})
                try {
...
class SearchTypeCreatorCmd(Command):
    ...
    def execute(my):
        ...
        my.description = "Registered sType '%s'" % search_type
    ...
    def add_sidebar_views(my):
        ...
        # project_config = WidgetDbConfig.get_by_search_type("SideBarWdg", "project_view")
        # def_config = WidgetDbConfig.get_by_search_type("SideBarWdg", "definition")
