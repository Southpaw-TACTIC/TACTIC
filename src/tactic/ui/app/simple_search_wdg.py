...
class SimpleSearchWdg(BaseRefreshWdg):
    ...
    def init(my):
        ...
        my.search_type = Project.extract_base_search_type(my.search_type)
    ...
    def get_top(my):
        ...
        #top.add_style("border-width: 1px 0px 1px 0px")
        #top.add_style("border-style: solid")
        #top.add_style("border-color: %s" % border_color)
        ...
        td.add_border()
        td.add(search_wdg)
        td.add_color("background", "background", -20)
    ...
    def get_display(my):
        ...
        elements_wdg.add_color("background", "background", -15 )
        ...
        for i, element_name in enumerate(element_names):
            ...
            if attrs.get('view') == 'false':
                ...
                title_td.add_style('display: none')
