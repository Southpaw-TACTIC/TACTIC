...
class SystemInfoWdg(BaseRefreshWdg):
    ...
    def get_display(my):
        ...
        top.add('<br>')
        top.add(DivWdg('Link Test', css='maq_search_bar'))
        top.add('<br>')
    ...
    def handle_directories(my, top):
        ...
        top.add(DivWdg('Asset Folders', css='maq_search_bar'))
        mailserver = Config.get_value("services", "mailserver")
        table = Table()
        table.add_color("color", "color")
        table.add_style("margin: 10px")
    ...
    def handle_python_script_test(my, top):
        top.add(DivWdg('Python Script Test', css='maq_search_bar'))
    ...
    def handle_load_balancing(my, top):
        # deal with asset directories
        top.add(DivWdg('Load Balancing', css='maq_search_bar'))
        table = Table()
    ...
    def handle_sidebar_clear(my, top):
        top.add(DivWdg('Clear Side Bar Cache ', css='maq_search_bar'))
        table = Table()
        table.add_color("color", "color")
        table.add_style("margin: 10px")
        top.add(table)
