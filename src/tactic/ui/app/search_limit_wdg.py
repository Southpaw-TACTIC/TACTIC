...
class SearchLimitWdg(Widget):
    ...
    def __init__(my, name='search_limit', label="Showing", limit=20, refresh=True):
    ...
    def alter_search(my, search):
        ...
        if not my.chunk_size:
            ...
            if search_limit:
                ...
                # this provides backward compatibility to Old TableLayout that uses a chunk size of 100 as default
                my.search_limit = 100
...
class SearchLimitSimpleWdg(BaseRefreshWdg):
    ...
    def get_display(my):
        ...
        bgcolor2 = top.get_color("background3", -5)
        top.add_relay_behavior( {
            'type': 'mouseover',
            'bgcolor': bgcolor2,
            'bvr_match_class': 'spt_link',
        ...
        # find the range ... always show 10 steps
        start_page = current_page - 5
        if start_page < 1:
            start_page = 1

        if start_page + 10 < num_pages:
        ...
        for i in range(start_page, end_page + 1):
            ...
            if i == current_page:
                ...
                td.add_color("background", "background3", 5)
