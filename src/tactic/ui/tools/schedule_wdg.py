...
class ScheduleToolWdg(BaseRefreshWdg):
    ...
    def get_display(my):
        ...
        bottom.add_class("spt_schedule_bottom")
        bottom.add_border()
        bottom.add_style("overflow: hidden")

        from tactic.ui.panel import ViewPanelWdg
        layout = ViewPanelWdg(search_type="sthpw/task", view="table")
        bottom.add(layout)
        """
...
class ScheduleUserToolWdg(BaseRefreshWdg):
    ...
    def get_display(my):
        ...
        name_wdg.add_style("font-size: 14px")
        name_wdg.add_style("font-weight: bold")
        name_wdg.add_style("padding: 5px")
        name_wdg.add_style("margin-left: -5px")
        name_wdg.add_gradient("background", "background")
        name_wdg.add_style("height: 20px")
        name_wdg.add_style("margin-bottom: 0px")
        name_wdg.add_style("overflow-y: hidden")
