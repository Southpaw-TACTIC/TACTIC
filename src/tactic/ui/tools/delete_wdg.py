...
#
#
__all__ = ["DeleteToolWdg", "DeleteCmd", "DeleteSearchTypeToolWdg", 'DeleteSearchTypeCmd']
...
__all__.append("DeleteProjectToolWdg")
__all__.append("DeleteProjectCmd")
class DeleteProjectToolWdg(DeleteToolWdg):
    ...
    def get_display(my):
        ...
        for search_type_obj in search_types:
            ...
            search_type = search_type_obj.get_code()
...
class DeleteProjectCmd(DeleteCmd):
    ...
    def execute(my):
        ...
        if not impl.database_exists(db_resource):
            raise TacticException("Database [%s] is already deleted. You can delete the project manually."%project_code)
