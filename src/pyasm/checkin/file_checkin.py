...
class FileAppendCheckin(FileCheckin):
    ...
    def __init__(my, snapshot_code, file_paths, file_types,  mode=None, keep_file_name=True,source_paths=[], dir_naming=None, file_naming=None, checkin_type='strict', update_versionless=True):
        '''
        ...
        my.update_versionless = update_versionless
