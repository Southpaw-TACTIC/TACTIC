...
class WebLoginWdg(Widget):
    ...
    def get_display(my):
        ...
        # FIXME: this doesn't work because of javascript and ajax problem ...
        # if ajax resubmit or refresh
        #if web.get_form_value("ajax"):
        #    return HtmlElement.script("document.form.submit()")
        ...
        if admin_login.get_value('s_status') =='retired':
        ...
        div.add_gradient("background", "background3", 0, -10)
        div.add_style("border: solid 2px %s" % div.get_color("border",-15))
        div.set_box_shadow(color="#CCC")
