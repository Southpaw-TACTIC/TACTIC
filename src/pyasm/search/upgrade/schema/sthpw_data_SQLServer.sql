...
-- Allow specification of the ID of the row to insert.

SET IDENTITY_INSERT search_object ON
...
INSERT INTO search_object (id, search_type, namespace, description, [database], table_name, class_name, title, [schema]) VALUES (16, 'sthpw/milestone', 'sthpw', 'Project Milestones', 'sthpw', 'milestone', 'pyasm.search.SObject', 'Project Milestones', 'public');
...
INSERT INTO search_object (id, search_type, namespace, description, [database], table_name, class_name, title, [schema]) VALUES (31, 'flash/design_pack', 'flash', 'Design Pack', '{project}', 'funpack', 'pyasm.flash.FlashFunpack', 'Design Pack', 'public');
...
INSERT INTO search_object (id, search_type, namespace, description, [database], table_name, class_name, title, [schema]) VALUES (35, 'flash/layer', 'flash', 'LFlash Layers', '{project}', 'layer', 'pyasm.flash.FlashLayer', 'LFlash Layers', 'public');
...
INSERT INTO search_object (id, search_type, namespace, description, [database], table_name, class_name, title, [schema]) VALUES (44, 'effects/plate', 'effects', 'Production Plates', '{project}', 'plate', 'pyasm.effects.biz.Plate', 'Production Plates', 'public');
...
INSERT INTO search_object (id, search_type, namespace, description, [database], table_name, class_name, title, [schema]) VALUES (90, 'prod/plate', 'prod', 'Production Plates', '{project}', 'plate', 'pyasm.effects.biz.Plate', 'Production plates', 'public');
...
INSERT INTO search_object (id, search_type, namespace, description, [database], table_name, class_name, title, [schema]) VALUES (107,'flash/pickup_request', 'flash', 'Pickup Request', '{project}', 'pickup_request', 'pyasm.flash.FlashSObject', 'Pickup Request', 'public');
...
SET IDENTITY_INSERT search_object OFF
...
--
SET IDENTITY_INSERT pref_list ON
...
SET IDENTITY_INSERT pref_list OFF
...
INSERT INTO translation (id, [language], msgid, msgstr, line, [login], [timestamp]) VALUES (59, 'ja', 'sobject n/a for snapshot code[%s]', NULL, 'C:/Program Files/Southpaw/Tactic/src/pyasmwidgetfile_wdg.py:215', NULL, '2007-06-16 13:56:08.703');
...
--
SET IDENTITY_INSERT project_type ON
...
--INSERT INTO "project_type" ([id], "code", "dir_naming_cls", "file_naming_cls", "code_naming_cls", "node_naming_cls", "sobject_mapping_cls", "s_status", "type", "repo_handler_cls") VALUES (2, 'flash', 'pyasm.flash.FlashDirNaming', '', 'pyasm.flash.FlashCodeNaming', '', 'pyasm.flash.biz.FlashMapping', NULL, 'flash', NULL);
...
SET IDENTITY_INSERT project_type OFF
--
-- PostgreSQL database dump complete
--
...
--
SET IDENTITY_INSERT access_rule ON
...
SET IDENTITY_INSERT access_rule OFF
...
SET IDENTITY_INSERT command OFF
