...
class Upgrade(object):
    ...
    def __init__(my, version, is_forced=False, project_code=None, quiet=False):
    ...
    def execute(my):
        ...
        if database_type != "PostgreSQL":
            # general an upgrade
            import imp
            from pyasm.search.upgrade.sqlite import *
            from pyasm.search.upgrade.mysql import *
            from pyasm.search.upgrade.sqlserver import *
