...
class Project(SObject):
    ...
    def get_project_db_resource(my):
        ...
        db_resource = DbResource(database=database, host=host, port=port, vendor=vendor)
        Container.put(key, db_resource)
    ...
    def set_project(cls, project_code):
        ...
        security = Environment.get_security()
        # FIXME:
        # unfortunately, it is possible to call this before one is 
