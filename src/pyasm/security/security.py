...
class Site(object):
    ...
    def update_project(self, project_code, site):
        ...
        update_sql = 'select code, last_version_update from project'
        ...
        for code, version in project_version:
            if version and code:
                if version != newest_version:
                    os.system("python /spt/tactic/TACTIC/src/bin/upgrade_db.py -y -p %s -s %s" % (code, site))
        ...
        for code, version in plugins:
            ...
            if os.path.exists(manifest_path):
                ...
                if not latest_version:
                    ...
                    installer.execute()
        sudo.exit()
    update_project = classmethod(update_project)
