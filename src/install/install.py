...
class Install:
    ...
    def change_directory_ownership(my):
        if os.name != 'nt':
            print "Changing directory ownership of tmp_dir and site_dir."
...
VALUES ('shot_attr_change', 'Attribute Changes For Shots', 'email', 'prod/shot', 'update|prod/shot');
    ...
    def install_to_python(my, install_defaults=False):
        ...
        python_site_packages_dir = distutils.sysconfig.get_python_lib()
        ...
        if not os.path.exists(python_site_packages_dir):
            if os.name == 'nt':
                ...
                if os.path.exists(linux_version_path):
                ...
                raise Exception("The TACTIC installer currently only supports NT, MAC or POSIX.  Exiting due to unsupported OS.")
