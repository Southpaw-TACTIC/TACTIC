...
%prep
echo "Prepare TACTIC"
rm -rf $RPM_BUILD_DIR/tactic-4.9
zcat $RPM_SOURCE_DIR/tactic-4.9.tar.gz | tar -xvf -
...
#install -m 755 $RPM_BUILD_DIR/config/service/tactic $RPM_BUILD_ROOT/etc/init.d/tactic
...
# TACTIC systemctl script
mkdir -p "$RPM_BUILD_ROOT/etc/systemd/system"
install -m 755 $RPM_BUILD_DIR/config/service/tactic.service $RPM_BUILD_ROOT/etc/systemd/system/tactic.service
...
echo
echo "python3 /opt/tactic/tactic/src/pyasm/search/upgrade/postgresql/bootstrap_load.py"
echo
echo
...
%config(noreplace) /etc/systemd/system/tactic.service
