...
class TacticServerStub(object):
    ...
    def insert_multiple(self, search_type,  data, metadata=[], parent_key=None, use_id=False, triggers=True):
        ...
        '''
        return self.server.insert_multiple(self.ticket, search_type, data, metadata, parent_key, use_id, triggers)
    ...
    def get_parent(self, search_key, columns=[], show_retired=False):
        ...
        '''
        return self.server.get_parent(self.ticket, search_key, columns, show_retired)
    ...
    def connect_sobjects(self, src_sobject, dst_sobject, context='default'):
        ...
        '''
        return self.server.connect_sobjects(self.ticket, src_sobject, dst_sobject, context)
    ...
    def create_snapshot(self, search_key, context, snapshot_type="file",
        ...
        '''
        return self.server.create_snapshot(self.ticket, search_key, context, snapshot_type, description, is_current, level_key, is_revision, triggers)
    ...
    def simple_checkin(self, search_key, context, file_path,
        ...
        snapshot = self.server.simple_checkin(self.ticket, search_key, context, file_path, snapshot_type, description, use_handoff_dir, file_type, is_current, level_key, metadata, mode, is_revision, info, keep_file_name, create_icon, checkin_cls, context_index_padding, checkin_type, source_path, version)
    ...
    def directory_checkin(self, search_key, context, dir, snapshot_type="directory", description="No description", file_type='main', is_current=True, level_key=None, metadata={}, mode="copy", is_revision=False, checkin_type='strict'):
    ...
    def add_directory(self, snapshot_code, dir, file_type='main', mode="copy", dir_naming='', file_naming=''):
        ...
        use_handoff_dir = True
        create_icon = False
        return self.server.add_file(self.ticket, snapshot_code, dir, file_type, use_handoff_dir, mode, create_icon, dir_naming, file_naming )
 




    def checkout(self, search_key, context="publish", version=-1, file_type='main', to_dir=".", level_key=None, to_sandbox_dir=False, mode='copy'):
    ...
    def get_snapshot(self, search_key, context="publish", version='-1', revision=None, level_key=None, include_paths=False, include_full_xml=False, include_paths_dict=False, include_files=False, include_web_paths_dict=False, versionless=False, process=None):
        ...
        [/code]
        '''
        return self.server.get_snapshot(self.ticket, search_key, context, version, revision, level_key, include_paths, include_full_xml, include_paths_dict, include_files, include_web_paths_dict, versionless, process)
    ...
    def get_dependencies(self, snapshot_code, mode='explicit', tag='main', include_paths=False, include_paths_dict=False, include_files=False, repo_mode='client_repo', show_retired=False):
        ...
        a list of snapshots
        '''
        return self.server.get_dependencies(self.ticket, snapshot_code, mode, tag, include_paths, include_paths_dict, include_files, repo_mode, show_retired)


    def get_all_dependencies(self, snapshot_code, mode='explicit', type='ref', include_paths=False,  include_paths_dict=False, include_files=False, repo_mode='client_repo', show_retired=False):
    ...
    # Note methods
    #
    def create_note(self, search_key, note, process="publish", subcontext=None, user=None):
        ...
        ''' 
        return self.server.create_note(self.ticket, search_key, process, subcontext, note, user)
    ...
    # Directory methods
    #
    def get_paths(self, search_key, context="publish", version=-1, file_type='main', level_key=None, single=False, versionless=False):
        ...
        '''
        return self.server.get_paths(self.ticket, search_key, context, version, file_type, level_key, single, versionless)
    ...
    def get_all_paths_from_snapshot(self, snapshot_code, mode='client_repo', expand_paths=False, filename_mode='',file_types=[]):
        ...
        return self.server.get_all_paths_from_snapshot(self.ticket, snapshot_code, mode, expand_paths, filename_mode, file_types)
    ...
    def get_virtual_snapshot_path(self, search_key, context="publish", snapshot_type="file", level_key=None, file_type='main', file_name='', mkdirs=False, protocol='client_repo', ext=''):
    ...
    #
    def set_config_definition(self, search_type, element_name, config_xml="", login=None):
        ...
        '''
        return self.server.set_config_definition(self.ticket, search_type, element_name, config_xml, login)
