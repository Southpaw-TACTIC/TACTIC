...
spt.dg_table._search_cbk = function(evt, bvr)
{
    ...
    if (pat.test(class_name)) {
        var attr_list = ['expand_mode','show_name_hover','scale','sticky_scale','top_view', 'bottom_view','aspect_ratio','show_drop_shadow', 'title_expr', 'overlay_expr', 'overlay_color', 'allow_drag', 'upload_mode'];
