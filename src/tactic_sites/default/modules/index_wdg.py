...
class IndexWdg2(Widget):
    def get_display(my):
        ...
        # make sure it is licensed and if not, popup a window
        # DEPRECATED: this is no longer necessary because the main
        # page header contains the license manager
        #license = security.get_license()
        #if not license.is_licensed():
        #    from tactic.ui.app import LicenseManagerWdg
        #    widget.add(LicenseManagerWdg())
        ...
        if not is_installed:
            ...
            for i, project in enumerate(projects):
                ...
                img_div.set_box_shadow(value="1px 1px 1px 1px")
